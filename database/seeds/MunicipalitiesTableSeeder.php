...
class MunicipalitiesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($tsCityByDepartments as $key=>$department){

            foreach($department as $city){
                DB::table('municipalities')->insert(['mcp_name' => $city, 'dpt_id' => $key]);
